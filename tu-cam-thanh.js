(async () => {
    ...
    const CSS = `
        ...
        /* ===== QUÂN SỰ - GIAO DIỆN DOANH TRẠI ===== */
        
        #panel-military .cwe-toolbar {
            display: flex !important;
            gap: 10px !important;
            margin-bottom: 14px !important;
        }
        
        #panel-military .zjc-search {
        ...
        #panel-military #list-military-camps {
            display: flex;
            flex-direction: column;
            gap: 11px;
        }
        
        #panel-military #list-military-camps .cwe-event-row {
            ...
            border: 1px solid rgba(199,155,93,.30) !important;
            border-radius: 13px !important;
        
            box-shadow: none !important;
        }
        
        #panel-military #list-military-camps .cwe-event-row:hover {
            border-color: rgba(199,155,93,.55) !important;
        }
        
        /* ===== DÒNG TRÊN: TÊN DOAN + TRÚ ĐỊA ===== */
        
        #panel-military #list-military-camps .cwe-event-when {
            ...
            border-bottom: 1px solid rgba(116,102,83,.28);
        }
        
        #panel-military #list-military-camps .cwe-event-when i {
            position: absolute !important;
            left: 0 !important;
        }
        
        #panel-military #list-military-camps .cwe-event-when strong {
            color: var(--ink-bright) !important;
        ...
        #panel-military #list-military-camps .cwe-event-when span {
        ...
        #panel-military #list-military-camps .cwe-command-actions {
        ...
        #panel-military #list-military-camps .cwe-command-actions button {
        ...
        #panel-military #list-military-camps .cwe-event-story {
        ...
        #panel-military #list-military-camps .cwe-event-story h4 {
        ...
        #panel-military #list-military-camps .cwe-event-story p {
            margin: 0 !important;
            line-height: 1.5 !important;
            font-size: 10px !important;
            color: var(--muted) !important;
        ...
        /* ===== BIẾN CÁC DÒNG CHỈ SỐ THÀNH KHỐI GỌN ===== */
        
        #panel-military #list-military-camps .cwe-event-story p:nth-of-type(1) {
            padding: 8px 9px !important;
            margin-bottom: 7px !important;
            border: 1px solid rgba(116,102,83,.20) !important;
            border-radius: 7px !important;
            background: rgba(0,0,0,.20) !important;
        }
        
        #panel-military #list-military-camps .cwe-event-story p:nth-of-type(2) {
            padding: 6px 8px !important;
            border-top: 1px solid rgba(116,102,83,.18) !important;
        }
        
        #panel-military #list-military-camps .cwe-event-story p:nth-of-type(3) {
            margin-top: 5px !important;
            padding-top: 7px !important;
            border-top: 1px dashed rgba(116,102,83,.25) !important;
        }
        
        /* ===== THỐNG KÊ ĐẦU TRANG ===== */
        
        #panel-military #military-stats-container {
            margin-bottom: 13px;
        }
        
        #panel-military .cm-military-head {
            display: flex;
        ...
        #panel-military .cm-military-title {
            display: flex;
            align-items: center;
            gap: 9px;
        }
        
        #panel-military .cm-military-title-mark {
            width: 5px;
            height: 24px;
            flex-shrink: 0;
        ...
        #panel-military .cm-military-title h2 {
            margin: 0;
            color: var(--ink-bright);
            font-size: 21px;
        }
        
        #panel-military .cm-military-subtitle {
            margin: 3px 0 0 14px;
            color: var(--muted);
            font-size: 10px;
        }
        
        #panel-military .cm-military-total {
            display: flex;
            flex-shrink: 0;
        ...
        #panel-military .cm-military-total-item {
            padding: 7px 12px;
            min-width: 90px;
        }
        
        #panel-military .cm-military-total-item + .cm-military-total-item {
            border-left: 1px solid var(--line);
        }
        
        #panel-military .cm-military-total-label {
            display: block;
            color: var(--faint);
            font-size: 8px;
        ...
        #panel-military .cm-military-total-value {
            display: block;
            margin-top: 2px;
            color: var(--gold);
            font-size: 12px;
        ...
        #panel-military .cm-military-stat-grid {
            display: grid;
            grid-template-columns: repeat(3, minmax(0,1fr));
            gap: 9px;
        }
        
        #panel-military .cm-military-stat {
            min-width: 0;
            padding: 10px 11px;
            border: 1px solid var(--line);
            border-radius: 8px;
        ...
        #panel-military .cm-military-stat-label {
            color: var(--muted);
            font-size: 9px;
        }
        
        #panel-military .cm-military-stat-value {
            margin-top: 3px;
            color: var(--ink-bright);
            font-size: 15px;
            font-weight: 700;
        ...
        #panel-military .cm-military-stat-value small {
            color: var(--muted);
            font-size: 9px;
            font-weight: 400;
        }
        
        #panel-military .cm-military-stat-icon {
            float: right;
            margin-top: -23px;
            color: var(--gold);
            font-size: 13px;
        ...
        #panel-military .cm-camp-metrics {
            display: grid;
        ...
        #panel-military .cm-camp-metric {
            min-width: 0;
        }
        
        #panel-military .cm-camp-metric-top {
            display: flex;
            justify-content: space-between;
            gap: 5px;
            margin-bottom: 4px;
        ...
        #panel-military .cm-camp-metric-top span {
            color: var(--muted);
            font-size: 9px;
            white-space: nowrap;
        }
        
        #panel-military .cm-camp-metric-top b {
            font-size: 9px;
            white-space: nowrap;
        }
        
        #panel-military .cm-camp-bar {
            height: 4px;
            overflow: hidden;
            border-radius: 99px;
        ...
        #panel-military .cm-bar-logistics i,
        #panel-military .cm-bar-fatigue i {
            background: var(--jade);
        }
        
        #panel-military .cm-bar-danger i {
            background: var(--cinnabar-bright);
        }
        
        /* ===== TRANG BỊ / TRẠNG THÁI ===== */
        
        #panel-military .cm-camp-bottom {
            grid-column: 1 / -1;
            display: flex;
            align-items: center;
            justify-content: space-between;
            gap: 10px;
            padding-top: 8px;
            border-top: 1px solid rgba(116,102,83,.20);
        }
        
        #panel-military .cm-camp-equipment,
        #panel-military .cm-camp-alerts {
            display: flex;
            flex-wrap: wrap;
            align-items: center;
            gap: 5px;
        ...
        #panel-military .cm-camp-label {
            color: var(--faint);
            font-size: 9px;
        }
        
        #panel-military .cm-equip-tag,
        #panel-military .cm-alert-tag {
            padding: 2px 6px;
            border-radius: 4px;
            font-size: 8px;
        }
        ...
        #panel-military .cm-equip-tag {
            color: var(--ink);
            border: 1px solid rgba(116,102,83,.28);
            background: rgba(0,0,0,.20);
        }
        
        #panel-military .cm-alert-tag.good {
            color: var(--jade);
            border: 1px solid rgba(120,153,142,.35);
        }
        
        #panel-military .cm-alert-tag.warn {
            color: var(--gold);
            border: 1px solid rgba(199,155,93,.35);
        }
        
        #panel-military .cm-alert-tag.bad {
            color: var(--cinnabar-bright);
            border: 1px solid rgba(219,114,88,.35);
        }
        
        /* ===== KHÔNG CÓ DOAN ===== */
        
        #panel-military .cm-empty-military {
            padding: 25px;
            text-align: center;
            color: var(--muted);
    ...
    function renderMilitary() {
        ...
        doc.getElementById('military-stats-container').innerHTML = `
            <div class="cm-military-head">
        
                <div>
                    <div class="cm-military-title">
                        <span class="cm-military-title-mark"></span>
                        <h2>Quân đội dưới quyền</h2>
                    </div>
        
                    <div class="cm-military-subtitle">
                        Hệ thống phân phối binh ngạch, quân nhu và quyền điều động trung ương
                    </div>
                </div>
        
                <div class="cm-military-total">
        
                    <div class="cm-military-total-item">
                        <span class="cm-military-total-label">Tại biên</span>
                        <span class="cm-military-total-value">
                            ${Object.keys(camps).length} chi
                        </span>
                    </div>
        
                    <div class="cm-military-total-item">
                        <span class="cm-military-total-label">Tổng binh lực</span>
                        <span class="cm-military-total-value">
                            ${armySupply.people.toLocaleString()}
                            <small>người</small>
                        </span>
                    </div>
            ...
            <div class="cm-military-stat-grid">
        
                <div class="cm-military-stat">
                    <div class="cm-military-stat-label">
                        Nguyệt độ quân phí
                    </div>
        
                    <div class="cm-military-stat-value">
                        ${armySupply.cost.toLocaleString()}
                        <small>lượng</small>
                    </div>
        
                    <div class="cm-military-stat-icon">◉</div>
                </div>
                ...
                <div class="cm-military-stat">
                    ...
                    <div class="cm-military-stat-value">
                        ${grain.toLocaleString()}
                        <small>thạch</small>
                    </div>
        
                    <div class="cm-military-stat-icon">
                        ${armySupply.grain ? `${runway} tháng` : '—'}
                    </div>
                </div>
        ...
        if (arr.length === 0) {
            ...
            campHtml = `
                <div class="cm-empty-military">
                    Tạm không có doanh ngũ liên quan.
                </div>
            `;
            ...
            for (const { name, camp } of arr) {
                ...
                const stateColor =
                    camp['Trạng thái'] === 'Đãi mệnh'
                        ? 'var(--jade)'
                        : 'var(--cinnabar-bright)';
        
                const morale = clamp(number(camp['Sĩ khí'], 0), 0, 100);
                const training = clamp(number(camp['Huấn luyện'], 0), 0, 100);
                const logistics = clamp(number(camp['Hậu cần'], 0), 0, 100);
                const fatigue = clamp(number(camp['Bì lao'], 0), 0, 100);
        
                const equip = camp['Trang bị biên chế'] || {};
        
                const unpaid =
                    camp['Số tháng khiếm nợ'] > 0
                        ? `
                            <span class="cm-alert-tag bad">
                                Khiếm nợ ${camp['Số tháng khiếm nợ']} tháng
                            </span>
                          `
                        : `
                            <span class="cm-alert-tag good">
                                Không khiếm nợ
                            </span>
                          `;
        
                const noFood =
                    camp['Số ngày thiếu lương'] > 0
                        ? `
                            <span class="cm-alert-tag bad">
                                Đứt lương ${camp['Số ngày thiếu lương']} ngày
                            </span>
                          `
                        : `
                            <span class="cm-alert-tag good">
                ...
                const wounded =
                    camp['Thương binh'] > 0
                        ? `
                            <span class="cm-alert-tag warn">
                                Thương binh ${camp['Thương binh']}
                            </span>
                          `
                        : `
                            <span class="cm-alert-tag good">
                ...
                const equipItems = [
                    equip['Chủ chiến binh khí'],
                    equip['Viễn xạ binh khí'],
                    equip['Phòng cụ'],
                    equip['Hỏa khí'],
                    equip['Tọa kỵ']
                ];
        
                const equipHtml = equipItems
                    .map(item => item || 'Không')
                    .map(item => `
                        <span class="cm-equip-tag">
                            ${html(item)}
                        </span>
                    `)
                    .join('');
                    ...
                    <div class="cwe-event-row">
                        ...
                        <div class="cwe-event-when">
                            ...
                            <i style="
                                ...
                                box-shadow:0 0 0 1px ${stateColor};
                            "></i>
                        ...
                        <div class="cwe-command-actions">
                            ...
                            <button
                                class="primary"
                                data-action="open-military-command"
                                data-camp-name="${html(name)}"
                            >
                                Mở quân phủ thiêm áp
                            </button>
                        ...
                        <div class="cwe-event-story">
                            ...
                            <h4>
                                ...
                                Chủ tướng:
                                ${html(camp['Tướng lĩnh'] || 'Chưa định')}
        
                                · Binh lực:
                                ${Number(camp['Nhân số'] || 0).toLocaleString()}
                            ...
                            <p>
                                Binh chủng:
                                <strong>
                                    ${html(camp['Binh chủng'] || 'Chưa rõ')}
                                </strong>
        
                                · Đẳng cấp:
                                <strong>
                                    ${html(camp['Đẳng cấp'] || 'Chưa rõ')}
                                </strong>
                            </p>
                            ...
                            <div class="cm-camp-metrics">
        
                                <div class="cm-camp-metric">
        
                                    <div class="cm-camp-metric-top">
                                        <span>Sĩ khí</span>
                                        <b>${morale}/100</b>
                                    </div>
        
                                    <div class="cm-camp-bar">
                                        <i style="width:${morale}%"></i>
                                    </div>
                                ...
                                <div class="cm-camp-metric">
                                    ...
                                    <div class="cm-camp-bar cm-bar-logistics">
                                        <i style="width:${logistics}%"></i>
                                    </div>
                                ...
                                <div class="cm-camp-metric">
                                    ...
                                    <div class="
                                        cm-camp-bar
                                        ${fatigue > 60 ? 'cm-bar-danger' : 'cm-bar-fatigue'}
                                    ">
                                        <i style="width:${fatigue}%"></i>
                                    </div>
                            ...
                            <div class="cm-camp-bottom">
                                ...
                                <div class="cm-camp-equipment">
        
                                    <span class="cm-camp-label">
                                        Trang bị:
                                    </span>
                                    ...
                                    <span class="cm-camp-label">
                                        (${html(equip['Tề bị suất'] || 0)}% tề bị ·
                                        ${html(equip['Hoàn hảo suất'] || 0)}% hoàn hảo)
                                    </span>
        
                                </div>
        
        
                                <div class="cm-camp-alerts">
